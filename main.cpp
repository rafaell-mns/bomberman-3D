...
void spawnarbots(){
    ...
    if (bot2.ultimaDirecao == cima && !temColisao(bot2.x + 28, bot2.z, muro)) {
        ...
        do {
            novaDirecao = numeroAleatorio(1, 4); // 1 = cima, 2 = direita, 3 = esquerda, 4 = baixo
        } while (novaDirecao == bot2.ultimaDirecao); // Evita repetir a ˙ltima direÁ„o
    ...
    if (bot3.ultimaDirecao == cima && !temColisao(bot3.x + 28, bot3.z, muro)) {
        ...
        do {
            novaDirecao = numeroAleatorio(1, 4); // 1 = cima, 2 = direita, 3 = esquerda, 4 = baixo
        } while (novaDirecao == bot3.ultimaDirecao); // Evita repetir a ˙ltima direÁ„o
...
void somBomba() {
    // Cria um alias √∫nico para cada nova reprodu√ß√£o do som
    ...
    char playCommand[50];
    sprintf(playCommand, "play %s", audio);  // Prepara o comando de reprodu√ß√£o com o alias
...
{	
    ...
    mudar_musica += 1;
    if (mudar_musica == 5)  // Se ultrapassar o n√∫mero de m√∫sicas, volta para a primeira
        mudar_musica = 1;
